	...
	tests := []struct {
	...
	}{
		{
			...
			msg: dextypes.MsgDeposit{
				...
				Options:         []*dextypes.DepositOptions{{false, false}},
			},
		...
		},
		{
			...
			msg: dextypes.MsgDeposit{
				...
				AmountsA:        []math.Int{},
				AmountsB:        []math.Int{},
				Options:         []*dextypes.DepositOptions{{true, false}},
			},
			err: dextypes.ErrUnbalancedTxArray,
		},
		{
		...
		},
		{
			...
			msg: dextypes.MsgDeposit{
				...
				Options:         []*dextypes.DepositOptions{{false, false}, {false, false}, {false, false}},
			},

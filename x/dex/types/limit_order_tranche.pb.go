...
type LimitOrderTranche struct {
	...
	PriceTakerToMaker github_com_neutron_org_neutron_v10_utils_math.PrecDec `protobuf:"bytes,7,opt,name=price_taker_to_maker,json=priceTakerToMaker,proto3,customtype=github.com/neutron-org/neutron/v10/utils/math.PrecDec" json:"price_taker_to_maker" yaml:"price_taker_to_maker"` // Deprecated: Do not use.
	...
	MakerPrice            github_com_neutron_org_neutron_v10_utils_math.PrecDec `protobuf:"bytes,8,opt,name=maker_price,json=makerPrice,proto3,customtype=github.com/neutron-org/neutron/v10/utils/math.PrecDec" json:"maker_price" yaml:"maker_price"`
	DecReservesMakerDenom github_com_neutron_org_neutron_v10_utils_math.PrecDec `protobuf:"bytes,9,opt,name=dec_reserves_maker_denom,json=decReservesMakerDenom,proto3,customtype=github.com/neutron-org/neutron/v10/utils/math.PrecDec" json:"dec_reserves_maker_denom" yaml:"dec_reserves_maker_denom"`
	DecReservesTakerDenom github_com_neutron_org_neutron_v10_utils_math.PrecDec `protobuf:"bytes,10,opt,name=dec_reserves_taker_denom,json=decReservesTakerDenom,proto3,customtype=github.com/neutron-org/neutron/v10/utils/math.PrecDec" json:"dec_reserves_taker_denom" yaml:"dec_reserves_taker_denom"`
	DecTotalTakerDenom    github_com_neutron_org_neutron_v10_utils_math.PrecDec `protobuf:"bytes,11,opt,name=dec_total_taker_denom,json=decTotalTakerDenom,proto3,customtype=github.com/neutron-org/neutron/v10/utils/math.PrecDec" json:"dec_total_taker_denom" yaml:"dec_total_taker_denom"`
}
...
var fileDescriptor_8c2ded67c80756d1 = []byte{
	...
	,
}

...
type MsgPlaceLimitOrder struct {
	...
	// DEPRECATED: tick_index_in_to_out will be removed in future release; price_in_to_out should be used instead.
	...
	PriceInToOut   *github_com_neutron_org_neutron_v3_utils_math.PrecDec `protobuf:"bytes,11,opt,name=price_in_to_out,json=priceInToOut,proto3,customtype=github.com/neutron-org/neutron/v3/utils/math.PrecDec" json:"price_in_to_out" yaml:"price_in_to_out"`
}
...
type MsgMultiHopSwap struct {
	...
	ExitLimitPrice github_com_neutron_org_neutron_v3_utils_math.PrecDec `protobuf:"bytes,5,opt,name=exit_limit_price,json=exitLimitPrice,proto3,customtype=github.com/neutron-org/neutron/v3/utils/math.PrecDec" json:"exit_limit_price" yaml:"exit_limit_price"`
...
var fileDescriptor_a489f6e187d5e074 = []byte{
	...
	,
}
...
func (m *MsgPlaceLimitOrder) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.PriceInToOut != nil {
		{
			size := m.PriceInToOut.Size()
			i -= size
			if _, err := m.PriceInToOut.MarshalTo(dAtA[i:]); err != nil {
				return 0, err
			}
			i = encodeVarintTx(dAtA, i, uint64(size))
		}
...
func (m *MsgPlaceLimitOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PriceInToOut", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			var v github_com_neutron_org_neutron_v3_utils_math.PrecDec
			m.PriceInToOut = &v
			if err := m.PriceInToOut.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

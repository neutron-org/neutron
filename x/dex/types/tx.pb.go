...
type MsgWithdrawalResponse struct {
	Reserve0Withdrawn []cosmossdk_io_math.Int                   `protobuf:"bytes,1,rep,name=reserve0_withdrawn,json=reserve0Withdrawn,proto3,customtype=cosmossdk.io/math.Int" json:"reserve0_deposited" yaml:"reserve0_withdrawn"`
	Reserve1Withdrawn []cosmossdk_io_math.Int                   `protobuf:"bytes,2,rep,name=reserve1_withdrawn,json=reserve1Withdrawn,proto3,customtype=cosmossdk.io/math.Int" json:"reserve1_deposited" yaml:"reserve1_withdrawn"`
	SharesBurned      []github_com_cosmos_cosmos_sdk_types.Coin `protobuf:"bytes,3,rep,name=shares_burned,json=sharesBurned,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Coin" json:"shares_issued" yaml:"shares_burned"`
}
...
var fileDescriptor_a489f6e187d5e074 = []byte{
	...
	0x56, 0x3b, 0x66, 0xc4, 0xd8, 0x93, 0x61, 0xd9, 0x43, 0x0e, 0x48, 0x71, 0x1e, 0xbb, 0x66, 0xed,
	0x49, 0xd4, 0xe3, 0x15, 0x68, 0x57, 0xa2, 0x69, 0xbb, 0x2b, 0x4e, 0x29, 0xdd, 0x5d, 0x56, 0x57,
	...
	,
}
...
func (m *MsgWithdrawalResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Reserve1Withdrawn) > 0 {
		for iNdEx := len(m.Reserve1Withdrawn) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.Reserve1Withdrawn[iNdEx].Size()
				i -= size
				if _, err := m.Reserve1Withdrawn[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintTx(dAtA, i, uint64(size))
			}
	...
	if len(m.Reserve0Withdrawn) > 0 {
		for iNdEx := len(m.Reserve0Withdrawn) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.Reserve0Withdrawn[iNdEx].Size()
				i -= size
				if _, err := m.Reserve0Withdrawn[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintTx(dAtA, i, uint64(size))
			}
...
func (m *MsgWithdrawalResponse) Size() (n int) {
	...
	_ = l
	if len(m.Reserve0Withdrawn) > 0 {
		for _, e := range m.Reserve0Withdrawn {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
	if len(m.Reserve1Withdrawn) > 0 {
		for _, e := range m.Reserve1Withdrawn {
			l = e.Size()
			n += 1 + l + sovTx(uint64(l))
		}
	}
...
func (m *MsgWithdrawalResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			var v cosmossdk_io_math.Int
			m.Reserve0Withdrawn = append(m.Reserve0Withdrawn, v)
			if err := m.Reserve0Withdrawn[len(m.Reserve0Withdrawn)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			...
			var v cosmossdk_io_math.Int
			m.Reserve1Withdrawn = append(m.Reserve1Withdrawn, v)
			if err := m.Reserve1Withdrawn[len(m.Reserve1Withdrawn)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:

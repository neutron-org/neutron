...
type LimitOrderTrancheUser struct {
	...
	SharesWithdrawn cosmossdk_io_math.Int `protobuf:"bytes,6,opt,name=shares_withdrawn,json=sharesWithdrawn,proto3,customtype=cosmossdk.io/math.Int" json:"shares_withdrawn" yaml:"shares_withdrawn"` // Deprecated: Do not use.
	...
	DecSharesWithdrawn github_com_neutron_org_neutron_v10_utils_math.PrecDec `protobuf:"bytes,9,opt,name=dec_shares_withdrawn,json=decSharesWithdrawn,proto3,customtype=github.com/neutron-org/neutron/v10/utils/math.PrecDec" json:"dec_shares_withdrawn" yaml:"dec_shares_withdrawn"`
}
...
var fileDescriptor_67e5ffbd487ea05f = []byte{
	...
	,
}
...
func (m *LimitOrderTrancheUser) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.DecSharesWithdrawn.Size()
		i -= size
		if _, err := m.DecSharesWithdrawn.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
...
func (m *LimitOrderTrancheUser) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DecSharesWithdrawn", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.DecSharesWithdrawn.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:

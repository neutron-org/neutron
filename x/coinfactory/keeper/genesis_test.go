...
func (suite *KeeperTestSuite) TestGenesis() {
	...
	err := app.CoinfactoryKeeper.SetParams(context, types.Params{})
	suite.Require().NoError(err)
	app.CoinfactoryKeeper.InitGenesis(context, genesisState)

	exportedGenesis := app.CoinfactoryKeeper.ExportGenesis(context)

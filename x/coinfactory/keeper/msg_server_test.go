...
import (
	...
	testkeeper "github.com/neutron-org/neutron/v10/testutil/coinfactory/keeper"
...
func TestMsgCreateDenomValidate(t *testing.T) {
	k, ctx := testkeeper.CoinFactoryKeeper(t, nil, nil, nil)
		...
		},
		{
			...
			types.MsgSetDenomMetadata{
				...
				Metadata: banktypes.Metadata{
					DenomUnits: []*banktypes.DenomUnit{
						{
							Denom:    strings.Join([]string{"factory", "sun"}, types.Separator),
							Exponent: 0,
							Aliases:  []string{"sun"},
						},
					},
					Base:    strings.Join([]string{"factory", "sun"}, types.Separator),
					Display: strings.Join([]string{"factory", "sun"}, types.Separator),
					Name:    "noname",
					Symbol:  "SUN",
				},
			},
		...
		},
		{
			...
			types.MsgSetDenomMetadata{
				...
				Metadata: banktypes.Metadata{
					DenomUnits: []*banktypes.DenomUnit{
						{
							Denom:    strings.Join([]string{"bitcoin", "factory", "sun"}, types.Separator),
							Exponent: 0,
							Aliases:  []string{"sun"},
						},
					},
					Base:    strings.Join([]string{"bitcoin", "factory", "sun"}, types.Separator),
					Display: strings.Join([]string{"bitcoin", "factory", "sun"}, types.Separator),
					Name:    "noname",
					Symbol:  "SUN",
				},
			},

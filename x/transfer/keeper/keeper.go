...
import (
	...
	wrappedtypes "github.com/neutron-org/neutron/v10/x/transfer/types"
)
...
func (k KeeperTransferWrapper) Transfer(goCtx context.Context, msg *wrappedtypes.MsgTransfer) (*wrappedtypes.MsgTransferResponse, error) {
	...
	transferMsg.Encoding = msg.Encoding // types.NewMsgTransfer() doesn't have encoding parameter and doesn't set the field (as of ibc-go v10.5.0)

...
import (
	...
	testkeeper "github.com/neutron-org/neutron/v11/testutil/transfer/keeper"
	...
	"github.com/neutron-org/neutron/v11/x/transfer"
)
...
func TestHandleAcknowledgement(t *testing.T) {
	...
	CoinfactoryKeeper := mock_types.NewMockTokenfactoryKeeper(ctrl)
	...
	txModule := transfer.NewIBCModule(*txKeeper, wmKeeper, tokenfactoryKeeper, CoinfactoryKeeper)

...
// 1. Burns NTRN fee coins distributed to consumertypes.ConsumerRedistributeName in ICS (https://github.com/cosmos/interchain-security/v4/blob/v0.2.0/x/ccv/consumer/keeper/distribution.go#L17)

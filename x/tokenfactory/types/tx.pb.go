...
type MsgMint struct {
	...
	MintToAddress string     `protobuf:"bytes,2,opt,name=mintToAddress,proto3" json:"mintToAddress,omitempty" yaml:"mint_to_address"`
}
...
type MsgBurn struct {
	Amount          types.Coin `protobuf:"bytes,1,opt,name=amount,proto3" json:"amount" yaml:"amount"`
	BurnFromAddress string     `protobuf:"bytes,2,opt,name=burnFromAddress,proto3" json:"burnFromAddress,omitempty" yaml:"burn_from_address"`
}
...
type MsgSetBeforeSendHook struct {
	Denom        string `protobuf:"bytes,1,opt,name=denom,proto3" json:"denom,omitempty" yaml:"denom"`
	ContractAddr string `protobuf:"bytes,2,opt,name=contract_addr,json=contractAddr,proto3" json:"contract_addr,omitempty" yaml:"contract_addr"`
}
...
type MsgSetDenomMetadata struct {
	Metadata types1.Metadata `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata" yaml:"metadata"`
}
...
type MsgForceTransfer struct {
	Amount              types.Coin `protobuf:"bytes,1,opt,name=amount,proto3" json:"amount" yaml:"amount"`
	TransferFromAddress string     `protobuf:"bytes,2,opt,name=transferFromAddress,proto3" json:"transferFromAddress,omitempty" yaml:"transfer_from_address"`
	TransferToAddress   string     `protobuf:"bytes,3,opt,name=transferToAddress,proto3" json:"transferToAddress,omitempty" yaml:"transfer_to_address"`
}
...
var fileDescriptor_283b6c9a90a846b4 = []byte{
	...
	,
}

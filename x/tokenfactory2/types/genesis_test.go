...
func TestGenesisState_Validate(t *testing.T) {
	...
	bitcoin, err := types.GetTokenDenom("neutron1m9l358xunhhwds0568za49mzhvuxx9ux8xafx2", "bitcoin")
	require.NoError(t, err)
	litecoin, err := types.GetTokenDenom("neutron1m9l358xunhhwds0568za49mzhvuxx9ux8xafx2", "litecoin")
	require.NoError(t, err)

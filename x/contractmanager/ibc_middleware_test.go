...
func NewSudoLimitMiddleware(t testing.TB, cm types.ContractManagerWrapper) (SudoLimitWrapper, sdk.Context, *storetypes.KVStoreKey) {
	...
	k := SudoLimitWrapper{ContractManagerWrapper: cm}

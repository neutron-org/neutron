...
func ExportFixCmd(appExporter types.AppExporter, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "export-fix",
		Short: "(Fixed: ABCI) Export state to JSON",
		Args:  cobra.NoArgs,
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			appGenesis.Consensus = NewConsensusGenesis(exported.ConsensusParams, exported.Validators)
...
func NewConsensusGenesis(params cmtproto.ConsensusParams, validators []cmttypes.GenesisValidator) *genutiltypes.ConsensusGenesis {

...
$BINARY add-wasm-message instantiate-contract "$VAULT_CONTRACT_BINARY_ID" "$VAULT_INIT" --run-as ${ADMIN_ADDRESS} --admin ${ADMIN_ADDRESS}  --label "DAO_Neutron_voting_vault"  --home "$CHAIN_DIR"

...
FOUNDATION_ALLOCATION_U_NTRN=14074111000000  # the 1.41% of the supply, unallocated LTIs
...
$BINARY add-genesis-account $P2P_ALLOCATION_U_NTRN $P2P_ALLOCATION_U_NTRN --home "$CHAIN_DIR"

...
TOKEN_ISSUER_ADDRESS="TODO"
FOUNDATION_ADDRESS="TODO"

DAO_ALLOCATION=300000000000000untrn  # 30% to the DAO
TOKEN_ISSUER_ALLOCATION_U_NTRN=110000000000000untrn  # 11% of the supply, will be distributed among the early backers
FOUNDATION_ALLOCATION_U_NTRN=11868444000000untrn  # the 1.41% of the supply, unallocated LTIs
RESERVE_ALLOCATION_U_NTRN=240011111000000untrn # 24$ of the supply

$BINARY add-genesis-account $DAO_CONTRACT_ADDRESS $DAO_ALLOCATION --home "$CHAIN_DIR"

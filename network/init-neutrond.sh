...
## RESCUEEER
RESCUEEER_EOL=1684836000  # Sun May 21 2023 10:00:00 GMT+0000
...
# 30% to the DAO + Airdrops + Lockdrop (need to be sent from the dao address)
let DAO_ALLOCATION="300000000000000+$LOCKDROP_NTRN_INCENTIVES+$AIRDROP_AMOUNT"

DAO_ALLOCATION_U_NTRN=${DAO_ALLOCATION}untrn
TOKEN_ISSUER_ALLOCATION_U_NTRN_1=150000000000000untrn  # 15% P2P allocation amount
TOKEN_ISSUER_ALLOCATION_U_NTRN_2=110000000000000untrn  # 11% of the supply, will be distributed among the early backers

FOUNDATION_ALLOCATION_U_NTRN=80000000000000untrn  # 8% for LTIS
RESERVE_ALLOCATION_U_NTRN=240000000000000untrn # 24$ of the supply

$BINARY add-genesis-account $DAO_CONTRACT_ADDRESS $DAO_ALLOCATION_U_NTRN --home "$CHAIN_DIR"
$BINARY add-genesis-account $TOKEN_ISSUER_MULTISIG_ADDRESS_1 $TOKEN_ISSUER_ALLOCATION_U_NTRN_1 --home "$CHAIN_DIR"
$BINARY add-genesis-account $TOKEN_ISSUER_MULTISIG_ADDRESS_2 $TOKEN_ISSUER_ALLOCATION_U_NTRN_2 --home "$CHAIN_DIR"
$BINARY add-genesis-account $FOUNDATION_MULTISIG_ADDRESS $FOUNDATION_ALLOCATION_U_NTRN --home "$CHAIN_DIR"
$BINARY add-genesis-account $RESERVE_CONTRACT_ADDRESS $RESERVE_ALLOCATION_U_NTRN --home "$CHAIN_DIR"

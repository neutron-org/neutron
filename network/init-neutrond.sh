...
TOKEN_ISSUER_ADDRESS="neutron18g42rexsmmnkt32nf4qxv04glp0u8w7rwvfxzr"
FOUNDATION_ADDRESS="neutron1xumd0qd3pceu875vazn3w5m9n78cns7q5fhgj3"
...
TOKEN_ISSUER_ALLOCATION_U_NTRN=110000000000000untrn  # 11% of the supply, will be distributed among the early backers
FOUNDATION_ALLOCATION_U_NTRN=80000000000000untrn  # the 1.41% of the supply, unallocated LTIs
RESERVE_ALLOCATION_U_NTRN=240011111000000untrn # 24$ of the supply

$BINARY add-genesis-account $DAO_CONTRACT_ADDRESS $DAO_ALLOCATION_U_NTRN --home "$CHAIN_DIR"
$BINARY add-genesis-account $TOKEN_ISSUER_ADDRESS $TOKEN_ISSUER_ALLOCATION_U_NTRN --home "$CHAIN_DIR"
$BINARY add-genesis-account $FOUNDATION_ADDRESS $FOUNDATION_ALLOCATION_U_NTRN --home "$CHAIN_DIR"

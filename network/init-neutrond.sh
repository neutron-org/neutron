...
TOKEN_ISSUER_ALLOCATION_U_NTRN=260000000000000untrn  # 11% of the supply, will be distributed among the early backers + 15% P2P Alloction amount
...
$BINARY add-genesis-account $TOKEN_ISSUER_MULTISiG_ADDRESS $TOKEN_ISSUER_ALLOCATION_U_NTRN --home "$CHAIN_DIR"

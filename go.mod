...
require (
	...
	github.com/CosmWasm/wasmvm/v2 v2.0.4
...
replace (
	...
	// remove during v0.38.14+ upgrade
	github.com/cometbft/cometbft => github.com/neutron-org/cometbft v0.0.0-20241107091756-6a4bf72dc8c2

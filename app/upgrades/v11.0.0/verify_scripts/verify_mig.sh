...
assert_eq "gov.min_deposit[0].amount"           "300000000000"             "$(jq -r '.min_deposit[0].amount'            <<<"$gov")"
assert_eq "gov.expedited_min_deposit[0].amount" "1000000000000"            "$(jq -r '.expedited_min_deposit[0].amount'  <<<"$gov")"
assert_eq "gov.max_deposit_period"              "72h0m0s"                  "$(jq -r '.max_deposit_period'               <<<"$gov")"
assert_eq "gov.voting_period"                   "168h0m0s"                 "$(jq -r '.voting_period'                    <<<"$gov")"
assert_eq "gov.expedited_voting_period"         "72h0m0s"                  "$(jq -r '.expedited_voting_period'          <<<"$gov")"
assert_eq "gov.quorum"                          "0.300000000000000000"     "$(jq -r '.quorum'                           <<<"$gov")"
...
assert_eq "gov.min_initial_deposit_ratio"       "0.500000000000000000"     "$(jq -r '.min_initial_deposit_ratio'        <<<"$gov")"
